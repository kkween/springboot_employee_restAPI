...
public class EmployeeControllerIntTests {
    ...
    @Autowired
    private MockMvc mockMvc; //used to make Http request using perform() method

    @Autowired
    private EmployeeRepository employeeRepository; //used to perform different operations on database

    @Autowired
    private ObjectMapper objectMapper; //used for serialization and deserialization
