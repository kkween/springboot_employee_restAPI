...
import com.izooki.springboottesting.integration.AbstractContainerBaseTest;
...
//                .build();
        ...
        savedEmployee.setEmail("deb@gmail.com");
        savedEmployee.setFirstName("Deb");
        Employee updatedEmployee =  employeeRepository.save(savedEmployee);

        // then - verify the output
        assertThat(updatedEmployee.getEmail()).isEqualTo("deb@gmail.com");
        assertThat(updatedEmployee.getFirstName()).isEqualTo("Deb");
    }
